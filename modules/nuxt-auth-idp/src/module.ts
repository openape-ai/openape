    ...
    if (options.pages !== false) {
      extendPages((pages) => {
        const modulePages = [
          ...
          { name: 'openape-passkeys', path: '/passkeys', file: resolve('./runtime/pages/passkeys.vue') },
          { name: 'openape-ssh-keys', path: '/ssh-keys', file: resolve('./runtime/pages/ssh-keys.vue') },
          { name: 'openape-connected-services', path: '/connected-services', file: resolve('./runtime/pages/connected-services.vue') },
          { name: 'openape-delegations', path: '/delegations', file: resolve('./runtime/pages/delegations.vue') },
