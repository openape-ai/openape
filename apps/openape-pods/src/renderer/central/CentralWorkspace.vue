...
.central-desktop .central-sidebar{display:flex;flex-direction:column;height:calc(100vh - 72px);position:sticky;top:0;min-height:0}
.central-desktop .central-pod-list{min-height:0;overflow:auto;flex:1}
