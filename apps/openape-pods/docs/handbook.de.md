...
Optionale npm-Bibliotheken gehören zu diesem Skript: Klappe Abhängigkeiten · package.json auf, trage feste Versionen unter dependencies ein (zum Beispiel {"dependencies":{"csv-parse":"6.1.0"}}), speichere und wähle Abhängigkeiten vorbereiten. Bestätige den Download im nativen Dialog. Die Vorbereitung pausiert diesen Pod; andere Arbeiten müssen vorher abgeschlossen sein. Die App nutzt ein isoliertes temporäres HOME, ausschließlich Zugriff auf die öffentliche npm-Registry und keine Zugangsdaten oder Installationsskripte. V1 unterstützt nur reine JavaScript-Pakete; native Erweiterungen, ausführbare Links und Installations-Hooks werden abgelehnt. Ein Paketsatz ist auf 64 MiB, 10.000 Einträge und 1.000 festgeschriebene Pakete begrenzt. Die Vorbereitung endet nach spätestens drei Minuten und überwacht ihren temporären Speicherverbrauch. Reguläre Läufe installieren und aktualisieren keine Pakete. Der gesamte vorbereitete Paketbaum wird schreibgeschützt gespeichert, gesichert und vor der Ausführung geprüft. Bibliotheken teilen die Berechtigungen und den Zugriff auf Geheimnisse deines Skripts. Änderungen am Paketsatz ändern die Skriptfreigabe. Der Chat kann Pakete vorschlagen und vorbereitete Paketsätze wiederverwenden; neue Paketsätze bereitest du hier vor.
