...
const shots = [
  ['central-workspace-1280.png', 'One central workspace', 'Browser and desktop share the same Vue workspace. Online Pods show committed details and recent runs; offline Pods remain listed by name and status. (test/layout, synthetic service)'],
  ['central-workspace-560.png', 'Central workspace at narrow width', 'Navigation, execution controls and recent run receipts remain inside the 560-pixel viewport. (test/layout, synthetic service)'],
  ['central-workspace-de-dark.png', 'Central workspace in German and dark appearance', 'Shared translations and dark colors preserve readable controls at narrow width. (test/layout, synthetic service)'],
  ['codex-management-en-1060.png', 'Direct Pod management', 'The workspace contains descriptions and management tabs, with no embedded chat or Codex review queue.'],
  ['codex-management-de-560.png', 'German management at narrow width', 'Direct description editing stays inside the 560-pixel viewport.'],
  ['workspace-codex.png', 'Work from Codex', 'Connection settings explain direct owner administration and Codex-controlled confirmation.'],
