...
import { PERSONA_CATEGORIES, PERSONAS } from '../../server/utils/persona-catalog'

// Agent-Catalog documentation page: lists all 29 personas generated from
// persona-catalog.ts — the single source of truth for company personas.
useSeoMeta({
  title: 'Agent Catalog — Troop',
  description: 'All 29 personas available to compose your company. Generated from the agent-catalog source.',
})
</script>
