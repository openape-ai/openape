...
<template>
  ...
  >
    ...
    <div v-if="persona" class="flex items-center justify-center gap-1.5 mb-1">
      <UIcon :name="persona.icon" class="size-4" />
      <span class="text-xs font-medium text-gray-600 dark:text-gray-300">{{ persona.title }}</span>
    </div>
