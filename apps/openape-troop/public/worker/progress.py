...
# chat shows what the Operator is doing right now (tool call / writing / thinking).
last = '🧠 Operator denkt …'
    ...
    if t == 'assistant':
        for b in ev.get('message', {}).get('content', []):
            if b.get('type') == 'tool_use':
                ...
                last = '✍️ Operator formuliert die Antwort …'
    elif t == 'user':
        last = '🧠 Operator verarbeitet das Ergebnis …'
print(last)
