---
title: "Pods"
description: "Set up your first Pod, verify a manual result and stay in control of automation."
---
...
![Connect your personal accounts](/guides/pods/handbook-setup.png)
...
![Create your first Pod in chat](/guides/pods/handbook-chat.png)
...
![Review the Pod identity and provider permission](/guides/pods/handbook-identity.png)
...
![Allow only the access your task needs](/guides/pods/handbook-permissions.png)
...
![Set variables and secrets safely](/guides/pods/handbook-credentials.png)
...
![Run manually and check the result](/guides/pods/handbook-history.png)
...
![Enable a schedule deliberately](/guides/pods/handbook-settings.png)
...
![Back up and restore your work](/guides/pods/handbook-data.png)
...
![Organize pods in groups](/guides/pods/handbook-groups.png)
...
![Overview](/guides/pods/handbook-overview.png)
...
![Further detail: Inspect and edit your script](/guides/pods/handbook-script.png)
...
![Results and sources](/guides/pods/handbook-knowledge.png)
