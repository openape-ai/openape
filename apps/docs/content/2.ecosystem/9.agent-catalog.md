---
title: Agent Catalog
description: The catalog of 29 personas available to compose your OpenApe company.
---
...
| Category | Key | Description | Count |
|----------|-----|-------------|-------|
| Leadership & Coordination | `leadership` | Strategic roles that set direction and manage teams | 5 |
| Engineering | `engineering` | Technical roles that build and maintain systems | 12 |
| Design & Content | `design-content` | Creative roles for UX, content, and marketing | 3 |
| Data & Research | `data-research` | Analytical roles for data and research | 2 |
| Growth & Sales | `growth-sales` | Business development and growth roles | 2 |
| Operations & Support | `operations` | Support and community management roles | 3 |
| Finance & Legal | `finance-legal` | Financial oversight and compliance roles | 2 |
| **Total** | | | **29** |
