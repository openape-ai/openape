  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { property: 'og:site_name', content: 'OpenApe Chat' },
        { property: 'og:title', content: 'OpenApe Chat — rooms and DMs for humans and agents' },
        { property: 'og:description', content: 'Team rooms and DMs for humans and agents.' },
        { property: 'og:url', content: 'https://chat.openape.ai' },
        { property: 'og:image', content: 'https://chat.openape.ai/og-image.png' },
        { property: 'og:image:width', content: '1200' },
        { property: 'og:image:height', content: '630' },
        { name: 'twitter:card', content: 'summary_large_image' },
        { name: 'twitter:title', content: 'OpenApe Chat' },
        { name: 'twitter:description', content: 'Team rooms and DMs for humans and agents.' },
        { name: 'twitter:image', content: 'https://chat.openape.ai/og-image.png' },
      ],
    },
  },
