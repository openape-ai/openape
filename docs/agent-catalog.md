...
To compose your own ORG:
1. Spawn a CEO first to turn your vision into objectives
2. Add team leads (PM, CTO, Engineering Manager) to decompose objectives
3. Add specialists based on capability gaps
4. Assign tasks in the UI — agents autonomously pick up work
