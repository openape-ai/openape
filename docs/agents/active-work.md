...
[PR 120](https://repos.openape.ai/patrick/monorepo/pulls/120),
...
canonical base `4e5648237b478c7e5447578d8f92a3cef187d399`; implementation
source `a894db757efc544c370960e8b06e99a3ee9c1075`. The final documentation commit
does not alter the candidate code. Read the PR for exact-source external checks.
...
link rejection and multi-megabyte artifact transport. Native PR checks are recorded on PR 120. The self-contained HTML evidence is
`~/Downloads/OpenApe-Pods-central-a894db75/verification.html`, generated by the
existing `pnpm --filter @openape/pods report` pipeline.
