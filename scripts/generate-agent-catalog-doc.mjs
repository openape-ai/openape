...
> **Source of Truth**: This documentation is auto-generated from \`apps/openape-troop/server/utils/persona-catalog.ts\`. Do not edit manually.

## Source of Truth

- **Persona definitions**: \`apps/openape-troop/server/utils/persona-catalog.ts\` (auto-generated from \`agent-catalog\`)
