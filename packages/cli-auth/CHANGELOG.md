...
- [`1ce5fd6`](https://github.com/openape-ai/openape/commit/1ce5fd68d147967fbf5c30afed84d2f241bcfbab) Thanks [@patrick-hofmann](https://github.com/patrick-hofmann)! - Shorten the SP token-exchange fallback expiry from 30 days to 1 hour
  when an SP omits both `expires_at` and `expires_in` ([#283](https://github.com/openape-ai/openape/issues/283)). The old
